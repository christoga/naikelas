...
HTTPD_PIDFILE=/Applications/moodle/apache2/logs/httpd.pid


HTTPD="/Applications/moodle/apache2/bin/httpd -f /Applications/moodle/apache2/conf/httpd.conf"
...
. /Applications/moodle/apache2/bin/envvars
