...
MYSQL_PIDFILE=/Applications/moodle/mysql/data/mysqld.pid

MYSQL_START="/Applications/moodle/mysql/bin/mysqld_safe --defaults-file=/Applications/moodle/mysql/my.cnf --port=3306 --socket=/Applications/moodle/mysql/tmp/mysql.sock  --datadir=/Applications/moodle/mysql/data --log-error=/Applications/moodle/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
