...
#define DEFAULT_MYSQL_HOME "/Applications/moodle/mysql"
#define SHAREDIR "/Applications/moodle/mysql/share"
#define DEFAULT_BASEDIR "/Applications/moodle/mysql"
#define MYSQL_DATADIR "/Applications/moodle/mysql/data"
#define DEFAULT_CHARSET_HOME "/Applications/moodle/mysql"
#define PLUGINDIR "/Applications/moodle/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/Applications/moodle/mysql/etc"
